<?php global $smof_data; ?>
      ...
      <!-- START COPYRIGHT SECTION -->   	
	   ...
	   <div class="col-lg-12 clearfix footer  pb50 clearfix ">
              <div class="col-sm-3 mt30"> 
                <h5>Star Crazy Events</h5>
                <p>If you’re looking for an event management team you know you can trust, give us a shout. Star Crazy  Events is Austin, Texas’ premier event services 
                company. Large or small events, private parties, weddings and more; we get the job done so you can kick back and enjoy your next event.</p>
              </div>
               <div class="col-sm-3 mt30">
               <h5>Services</h5>
               <ul>
               <li><a href="javascript:void();">Promotional Events</a></li>
                <li><a href="javascript:void();"> Corporate Events</a></li>
                <li><a href="javascript:void();"> Concerts/Festivals/Conventions</a></li>
                <li><a href="javascript:void();"> Private Parties</a></li>
                <li><a href="javascript:void();"> Weddings/Receptions</a></li>
                <li><a href="javascript:void();"> Sponorship information</a></li>
                <li><a href="javascript:void();"> Advertise with Us</a></li>
                <li><a href="javascript:void();"> Affiliates</a></li>
                <li><a href="javascript:void();"> Work Here</a></li>
               ...
               <div class="col-sm-3 mt30"> 
                ...
                <form role="form">
                      <div class="form-group">
                       <div class=" col-xs-9 p0"><input type="email" class="form-control input-sm "  placeholder=""></div>
                            <button type="submit" class="btn btn-sm btn-default btn-go">GO</button>
                      </div>
                   
                </form>
                    <p>Enter your email address above to recieve the latest news, event information and promotional updates from Star Crazy Events!</p>
               </div>
               <div class="col-sm-3 mt30">
               <h5>Contact Us</h5>
               <p style="font-family:droid_sansbold; font-size:14px; margin:0px;">T:  1 512.584.1753</p>
               <p style="font-family:droid_sansbold;font-size:13px;">E: <span style="color:#f0982f">starcrazyevents@gmail.com</span></p>
               <a href="javascript:void();">  <img src="<?php bloginfo('template_directory');?>/images/twitter-2.png" alt="" class="img-responsive pull-left mb10 pr10" /></a>
               <a href="javascript:void();">  <img src="<?php bloginfo('template_directory');?>/images/facebook.png" alt="" class="img-responsive mb10" /></a>
               <p style="font-family:arial; font-size:14px;"><strong>Address</strong></p>
               <p style="font-family:arial; font-size:14px;">South Congress Ave.Austin,</p><p style="font-family:arial; font-size:14px;"> TX 78745</p>
               </div>
           
           </div>
           
        </div>
	<div class="copyright aligncenter copyrght">
